...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="gotoPay "method=post
			target="_blank">
		...
		<form name=tradequery action=WEB-INF/jsp/pay/alipay.trade.query.jsp method=post
			target="_blank">
		...
		<form name=traderefund action=WEB-INF/jsp/pay/alipay.trade.refund.jsp method=post
			target="_blank">
		...
		<form name=traderefundquery
			action=WEB-INF/jsp/pay/alipay.trade.fastpay.refund.query.jsp method=post
			target="_blank">
		...
		<form name=tradeclose action=WEB-INF/jsp/pay/alipay.trade.close.jsp method=post
			target="_blank">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "xixiVip";
		document.getElementById("WIDtotal_amount").value = "0.01";
		$("#WIDbody").val("成为VIP,可以发送高级弹幕");
