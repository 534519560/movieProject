...
.vipimg{
  ...
  float: right;
    ...
    $("#inputform").submit();
  	...
  	function retto(){
  	window.loaction.href="initIndexVideo";
    }
        ...
        <div id="header-search">
          <div class="logo-input">
            ...
            <div id="search-block">
              ...
              <form action="queryvideo/uploadUser" id="inputform" method="post">
 ...
 <img alt="##"  src="source/kong.png" style="margin-left: 400px;">
   ...
   <form action="queryvideo/uploadUser" method="post" id="getform">
   ...
   <input type="hidden" name="currentpage" value="${queryVideoList.currentpage}" id="getCurrentpage">
      <ul>
        ...
        <li><a href="javascript:goPage(${queryVideoList.prepage},'uploadUser')">上一页</a></li>
        </c:if>
       ...
       <li><a href="javascript:goPage(${index},'uploadUser')" class="pagenum active" style="background-color:${queryVideoList.currentpage==index ?'#49afcd':''};color:${queryVideoList.currentpage==index ?'white':''}">${index}</a></li>
         </c:forEach>
       
       
        
        <li><a href="javascript:goPage(${queryVideoList.nextpage},'uploadUser')">下一页</a></li>
        </c:if>
